package com.doc.roseya.ui.masjid
...
import com.doc.roseya.viewModel.MasjidViewModel
...
class MasjidActivity: AppCompatActivity(), OnMapReadyCallback {
    ...
    private fun setViewModel() {
        progressDialog.show()
        masjidViewModel = ViewModelProvider(this, ViewModelProvider.NewInstanceFactory()).get(MasjidViewModel::class.java)
